...
# CREATE TABLES
#Create staging tables - To copy logs from unstructured log files to a single database table
...
time_table_insert = ("""
   ...
   WHERE
      start_time NOT IN (SELECT DISTNCT start_time FROM time)
""")
